...
namespace ReSizer.ToolHelpers
{
    public class ImageProcessor
    {
        ...
        {
            Logger.WriteLine("Processing {0}", image.Name);
            ...
            Logger.WriteVerbose("New File Name: {0}{1}", outFileName, extension);
            ...
            Logger.WriteVerbose("Original Dimensions: {0}W by {1}H", defaultWidth, defaultHeight);
            ...
            foreach (var expectedImage in expectedImages)
            {
                ...
                Logger.WriteVerbose("New Dimensions for {0}: {1}W by {2}H", expectedImage.Key, scaledWidth, scaledHeight);
            }
            Logger.WriteLine();
        }
    }
